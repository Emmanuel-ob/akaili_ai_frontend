      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        <div v-else>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div
              class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6"
            >
            ...
            <div
              class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6"
            >
              <div class="flex items-center justify-between mb-2">
              ...
              <p class="text-sm text-green-700 mt-1">
                {{ rates.open_rate }}% open rate
              </p>
            </div>

            <div
              class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6"
            >
              <div class="flex items-center justify-between mb-2">
              ...
              <p class="text-sm text-purple-700 mt-1">
                {{ rates.click_rate }}% click rate
              </p>
            </div>

            <div
              class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-6"
            >
              <div class="flex items-center justify-between mb-2">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      v-if="event.event_type === 'opened'"
                      fill-rule="evenodd"
                      d="M10 12a2 2 0 100-4 2 2 0 000 4z"
                    />
                    <path
                      v-else-if="event.event_type === 'clicked'"
                      fill-rule="evenodd"
                      d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z"
                    />
                    <path
                ...
                <div class="flex-1">
                  ...
                  <p
                    v-if="event.link_url"
                    class="text-sm text-blue-600 truncate mt-1"
                  >
                    {{ event.link_url }}
                  </p>
...
const stats = computed(
  () => analytics.value?.stats || props.campaign.stats || {},
);
const rates = computed(
  () =>
    analytics.value?.rates || {
...
onMounted(async () => {
  try {
    analytics.value = await emailStore.fetchCampaignAnalytics(
      props.campaign.id,
    );
