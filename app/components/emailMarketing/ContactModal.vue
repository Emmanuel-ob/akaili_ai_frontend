  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          class="text-gray-400 hover:text-gray-600 font-sans"
          @click="$emit('close')"
        >
          <svg
            class="w-6 h-6"
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div>
          <h3
            class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2 font-subheading"
          >
            <svg
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="John"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 font-sans"
                required
              />
            </div>
            <div>
        ...
        <div>
          <div class="flex items-center justify-between mb-4">
            <h3
              class="text-lg font-semibold text-gray-900 flex items-center gap-2 font-subheading"
            >
              <svg
            ...
            <button
              type="button"
              class="px-3 py-1 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 flex items-center gap-1 font-sans"
          ...
          >
            <p class="text-sm text-blue-900 font-medium mb-2 font-sans">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :key="field"
                type="button"
                class="px-3 py-1 bg-white border border-blue-200 text-blue-700 text-sm rounded-lg hover:bg-blue-100 transition-colors font-sans"
          ...
          <div v-if="customFieldsList.length > 0" class="space-y-3">
            ...
            >
              <div class="flex-1 grid grid-cols-2 gap-3">
                <div>
                  <label
                    class="block text-xs font-medium text-gray-700 mb-1 font-subheading"
                  >
                    Field Name
                  </label>
                  <input
                    ...
                    class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 font-sans"
                  />
                </div>
                <div>
                  <label
          ...
          >
            ...
            <p class="text-gray-600 text-sm mb-2 font-sans">
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              <h4
                class="text-sm font-medium text-purple-900 mb-1 font-subheading"
              >
                About Custom Fields
              </h4>

              <p class="text-sm text-purple-700 font-sans">
                Custom fields allow you to store any additional information
                about contacts. You can add fields like Company, Job Title,
                Industry, Location, etc. These fields can be used in email
      ...
      >
        <button
          class="px-6 py-2 text-gray-600 hover:text-gray-900 font-sans"
          @click="$emit('close')"
        >
          Cancel
        </button>
        <button
          ...
          :class="[
            'px-6 py-2 rounded-lg font-medium font-sans',
            canSave && !saving
...
const canSave = computed(() => {
  return (
    formData.value.first_name && formData.value.email && formData.value.list_id
  );
});
