...
<template>
    <div class="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300 p-6">
        ...
        <div v-else-if="availableChatbots.length === 0" class="text-center py-12">
            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 max-w-lg mx-auto">
                <h3 class="text-lg font-medium text-yellow-800 dark:text-yellow-200 mb-2">No Chatbots Found</h3>
                <p class="text-yellow-700 dark:text-yellow-300/80 mb-4">
