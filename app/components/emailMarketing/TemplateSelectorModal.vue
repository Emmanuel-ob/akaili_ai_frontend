<template>
  ...
  >
    <div
      class="bg-white rounded-lg w-full max-w-5xl max-height-[85vh] overflow-hidden flex flex-col"
    >
      <!-- Header -->
      <div
      ...
      <div class="p-6 border-b border-gray-200">
        <div class="flex items-center gap-4">
          ...
          >
            ...
            <option
              v-for="category in emailStore.templateCategories"
              :key="category"
              :value="category"
            >
              {{ category }}
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2 font-subheading">
            No templates found
          </h3>
        ...
        >
          ...
          >
            ...
            <!-- Info -->
            <div class="p-4">
              <h3 class="font-semibold text-gray-900 mb-1 font-subheading">
                {{ template.name }}
              </h3>
              <p
            ...
            <!-- Hover Actions -->
            <div
              class="px-4 pb-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity"
            >
              <button
