      ...
      >
        ...
        <div class="mb-6">
          <div class="flex items-center gap-3 mb-2">
            <h3
              class="text-2xl font-bold text-gray-900 dark:text-white font-subheading leading-tight"
            >
              Invoice Details
            </h3>
            <span
        ...
        <!-- Invoice Info Grid -->
        <div
          class="grid grid-cols-2 gap-6 mb-6 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg"
        >
          <div>
        ...
        >
          <h4
            class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 font-subheading leading-tight"
          >
            Line Items
          </h4>
          <div
        ...
        <!-- Business Details -->
        <div
          v-if="invoice.business"
          class="mb-6 p-4 border border-gray-200 dark:border-slate-700 rounded-lg"
        >
          <h4
            class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 font-subheading leading-tight"
          >
          ...
          <div class="space-y-1 text-sm">
            ...
            <p
              v-if="invoice.business.location"
        ...
        <!-- Actions -->
        <div
          class="flex gap-3 pt-4 border-t border-gray-200 dark:border-slate-700"
        >
          <button
            class="flex-1 px-4 py-2 border border-gray-300 dark:border-slate-700 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition text-sm"
            @click="$emit('close')"
          >
            Close
          </button>
          ...
          <button
            ...
            class="flex-1 px-4 py-2 bg-[#9E4CFF] text-white rounded-lg font-medium hover:bg-purple-700 transition text-sm"
            @click="downloadPDF"
          >
            Download PDF
          </button>
