    ...
    <div class="bg-white h-[100vh]">
        ...
        <div v-if="!hasChatbot && !chatbotStore.loading" class="bg-yellow-50 border border-yellow-200 px-4 py-3 mb-4">
            <div class="flex items-center">
                ...
                <p class="text-yellow-800 text-sm">
                    <strong>No chatbot found.</strong> Create your first chatbot by filling out the form below and clicking "Create Chatbot".
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-1 text-center mx-4 mb-8 mt-5">
            <div
                ...
                :class="activeTab === tab.key ? 'active_chatbot_setup' : ''"
...
const currentChatbot = computed(() => chatbotStore.chatbots[0] || null)
